...
CLIENT_ID = json.loads(
    open('/d/Full_Stack/linux_server_project/client_secrets.json', 'r').read())['web']['client_id']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/d/Full_Stack/linux_server_project/client_secrets.json', scope='')
